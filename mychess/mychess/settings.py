...
DATABASE_URL = os.environ.get('DATABASE_URL', os.environ.get('LOCALPOSTGRES'))
if DATABASE_URL:
    databaseenv = dj_database_url.parse(DATABASE_URL, conn_max_age=600, ssl_require=True)
